  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md">
      ...
      <p className="text-gray-700">
        ...
        The app showcases real-time and historical stock price data, offering a seamless user experience through interactive tooltips, annotations, and chart options.
